...
const url = 'https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/r3V7tJtmkcUjxtxS0r6D/books';
...
export const getBooksData = createAsyncThunk('book/getBooksData', async () => {
  try {
